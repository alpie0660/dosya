    ...
    def run(self):
        ...
        while 1:
            ...
            try:
                ...
                # If during the first http request an error occurs
                # There's a chance the proxy won't work properly 
                # So you're changing proxies
                proxy = random.choice(listaproxy).split(':')
...
print("                 .----.Creator: Root.Kit .----.")

# input site
url = raw_input("Site: ")
host_url = url.replace("http://", "").replace("https://", "").split('/')[0]

# the proxy list from the proxy.txt file is loaded here
...
# nload (not loaded) is 1 when the threads have not all been started yet
# and becomes 0 when the threads boot cycle is over
nload = 1

# x is used to give the "id" of the thread
x = 0
